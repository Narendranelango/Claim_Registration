...
<body>
  <%  if(request.getAttribute("pol_num") instanceof String) 
		{	
	%>
<br>
	<%= request.getAttribute("pol_num") %>
	<%	}
		else
		{
	%>	 	
...
<form name="claimForm" action="create_claim.htm" method ="POST" >
<table align="center" border="1">	
	...
	<tr>
		<td>Policy Number</td>	
		<td><input type="text" name="policy_Number" placeholder="Enter policy number" size="30" required="required"></td>
	</tr>
	</table>
