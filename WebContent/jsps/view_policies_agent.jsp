...
<body>
	...
	<%		if(request.getAttribute("policy_details_agent") instanceof String)
			{
	%>	
			<br>
			<%=(String)request.getAttribute("policy_details_agent") %>
	<%		}
			else
			{
	%>		
	<%		List<Policy> policy_details=(List<Policy>)request.getAttribute("policy_details_agent");	
	...
	%>
		...
		<table align="center" border=1>
			...
			<tbody>
			<c:forEach items="${policy_details_agent}" var="policy">
				<%counter=counter+1; %>
					<tr>
						<td><%=counter%></td>
